...
class TcpSocket
{
    ...
    public:
        ptrdiff_t socketDescriptor() const;
        bool setSocketDescriptor(ptrdiff_t socketDescriptor);
    ...
    protected:
        ...
        std::shared_ptr<TcpSocketPrivate> d_ptr;
        TcpSocket(std::shared_ptr<TcpSocketPrivate> &&d);
};
